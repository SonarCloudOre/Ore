...
<div id="contenu">
    ...
    <div class="wrapper" id="htmltoimage">
        <div class="left">
            <img src="<?php echo 'photosEleves/' . $intervenant["PHOTO"] ?>" alt="user" width="100">
            <p>
                <img
                    src="https://chart.googleapis.com/chart?chs=70x70&cht=qr&chl=<?php echo $intervenant["ID_ELEVE"]; ?>&choe=UTF-8"
                    title="Id eleve"/>
            </p>
            <h2>2021-2022</h2>
        </div>
        <div class="right">
            ...
            <div class="projects">
                <div class="projects_data">
                    <div class="data">
                        <h4>Identifiant</h4>
                        <p><?php echo $identEleve["id"] ?></p>
                    </div>
                    <div class="data">
                        <h4>Mot de passe</h4>
                        <p><?php echo $identEleve["mdp"] ?></p>
                    </div>
                </div>
            </div>
