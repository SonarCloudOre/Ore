                        ...
                        <div class="menu-header-content btn-pane-right">
                            <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                <div class="avatar-icon rounded">
                                    <img src="<?php echo 'photosEleves/' . $intervenant["PHOTO"] ?>" alt="Avatar 5">
                                </div>
                            </div>
                            <div>
                                <br><h5
                                    class="menu-header-title"><?php echo $intervenant["PRENOM"] . ' ' . $intervenant["NOM"] ?></h5>
                                <h6 class="menu-header-subtitle">Élève</h6>
                            </div>
                                ...
                                <?php foreach ($lesDocs as $unDoc) {
                                  ...
                                  <div class="widget-content p-0">
                                      <div class="widget-content-wrapper">
                                          ...
                                          <div class="widget-content-left">
                                              <div class="widget-heading"><a href="./documentseleve/' . $unDoc['urlfichier'] . '">' . $unDoc['nom'] . '</a></div>
                                              <div class="widget-subheading mt-1 opacity-10">
                                                  <div class="badge badge-pill badge-dark">' . $unDoc['Classe'] . '</div>
                                                  <div class="badge badge-pill badge-dark">' . $unDoc['Matieres'] . '</div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
