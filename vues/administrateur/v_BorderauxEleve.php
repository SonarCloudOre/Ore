            ...
            <div class="card" id="bordereauTable">
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <div class="title">
                            Type : <?=$hasBanque ? "Tous" : ($type == 1 ? "Chèque" : "Carte Bancaire")?>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                                ...
                                foreach ($lesReglements as $unReglement) {
                                    $dateReglement = dateAnglaisVersFrancais($unReglement['DATE_REGLEMENT']);
                                    $montant = $unReglement['MONTANT'];
                                    $banque = $unReglement['BANQUE'];
                                    $numTransaction= $unReglement['NUMTRANSACTION'];
                                    $eleves = $pdo->recupeElevesWithReglement($unReglement['ID']);
                                    $nom = "";
                                    foreach ($eleves as $unEleve) {
                                        $nom = $unEleve['NOM'] . " " . $unEleve['PRENOM'] . "<br>";
                                    }
                                    $inforeglement = "";
                                    ...
                                    $pourHtml = "<tr>
                                            ...
                                            <td>$nom</td>";
                                    if ($type == 1 || $type == 0) {
                                        $pourHtml .= "<td>$banque</td>";
                                    }
                                    $pourHtml.= "<td>$inforeglement</td>";
                                    $pourHtml .= "<td class='amount'>$montant €</td></tr>";
                                    echo $pourHtml;
                                    $n++;
                                }
                            ?>
