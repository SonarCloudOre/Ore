<div id="contenu">
    ...
    <form name="frmConsultFrais" method="POST" action="index.php?choixTraitement=intervenant&action=valideModifInfos">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="position-relative form-group col-md-3">
                                ...
                                <input class="form-control" name="email" value="<?php echo $inter['EMAIL']; ?>"
                                       type="email" readonly><br>
                            </div>
                            ...
                            <div class="position-relative form-group col-md-5">
                                ...
                                <input class="form-control" name="adresse"
                                       value="<?php echo $inter['ADRESSE_POSTALE']; ?>" autofocus="" readonly><br>
                            </div>
                        ...
                        <div class="row">
                            <div class="position-relative form-group col-md-4">
                                ...
                                <input class="form-control" name="ville" value="<?php echo $inter['VILLE']; ?>"
                                       autofocus="" readonly><br>
                            </div>
                            ...
                            <div class="position-relative form-group col-md-3">
                                ...
                                <input class="form-control" name="nationalite"
                                       value="<?php echo $inter['NATIONALITE']; ?>" autofocus="" readonly><br>
                            </div>
