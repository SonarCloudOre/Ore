...
class GoogleCalendarApi
{
	...
	public function GetEventbyId($calendar_id, $event,$access_token) {
	...
	public function CreateCalendarEvent($calendar_id, $summary, $location, $description, $all_day, $event_time, $event_timezone, $access_token) {
