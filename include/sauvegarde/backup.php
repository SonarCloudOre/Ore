...
class BackupMySQL extends mysqli {
	...
	public function __construct($options = array()) {
		$default = array(
			'host' => ini_get('mysql51-52.perso'),
			'username' => ini_get('associatryagain'),
			'passwd' => ini_get('assORE1994'),
			'dbname' => 'associatryagain',
			'port' => ini_get('3306'),
			'socket' => ini_get('mysqld.sock'),
			// autres options
			'dossier' => './',
			'nbr_fichiers' => 20,
			'nom_fichier' => 'backup_ore'
			);
