...
<div class="bs-docs-example no-code">
  <select class="form-control" data-live-search="true" data-width="fit">
...
<div class="bs-docs-example">
  <select class="form-control" multiple data-max-options="2">
    <option>Mustard</option>
    <option>Ketchup</option>
    <option>Relish</option>
  </select>
...
<div class="bs-docs-example">
  <div class="form-group">
    ...
    <select class="form-control" multiple title="Choose one of the following..." data-width="fit">
      <option>Mustard</option>
      <option>Ketchup</option>
      <option>Relish</option>
    </select>
  ...
  <div class="form-group">
    ...
    <select class="form-control" title="Choose one of the following..." data-width="fit">
      <option>Mustard</option>
      <option>Ketchup</option>
      <option>Relish</option>
    </select>
...
<select class="form-control" data-width="75%">
  ...
</select>
```
...
```html
<select class="form-control" data-header="Select a condiment">
  ...
</select>
```
...
<div style="overflow:hidden;">
  ...
  <select class="form-control" data-container="body">
    ...
  </select>
</div>
```
